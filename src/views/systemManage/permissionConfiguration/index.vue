<template>
  <div class="permissionConfiguration">
      ...
      <el-col :span="20">
        <div class="left">
          <div class="btns">
            ...
            <el-button type="primary" icon="el-icon-delete" size="small" @click="empower">授权</el-button>
          </div>
    ...
    <el-dialog title="新建" :visible.sync="addDialog" width="25%">
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item :label="$t('devicetype.classifyAlias')">
          <el-radio-group v-model="form.type">
            <el-radio label="子部门"></el-radio>
            <el-radio label="岗位"></el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item :label="$t('devicetype.classifyAlias')">
    ...
    <el-dialog title="授权" :visible.sync="emDialog" width="35%">
      <el-row class="emtable">
        <el-col :span="12">
          <h2 style="border-right:1px solid #eeeeee;">功能菜单</h2>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="emDialog = false">取 消</el-button>
        <el-button type="primary" @click="emDialog = false">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
