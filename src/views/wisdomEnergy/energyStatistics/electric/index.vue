<template>
  <div class="electric">
    ...
    <div class="statis_chart">
       <p class="title">{{$t('electric.regionalPowerConsumptionChart')}}</p>
    ...
    <div class="statis_table">
      <p class="clearfix">
          <span class="pull-left title">{{$t('electric.regionalPowerConsumprionTable')}}</span>
        ...
        <el-table
          ...
          <el-table-column prop="id" :label="$t('common.serialNum')" width="180"></el-table-column>
            ...
            <el-table-column prop="amount3" :label="$t('electric.sumPowerConsumption')">
    ...
    <el-dialog
        :title="$t('electric.devPowerConsumptionList')"
        ...
        >
          ...
          <el-table-column prop="amount3" :label="$t('electric.sumPowerConsumption')"></el-table-column>
        </el-table>
        <el-pagination
          background
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="elecdialog = false">{{$t('common.cancel')}}</el-button>
